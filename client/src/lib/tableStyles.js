...
export const TABLE_HEADER_ROW = 'text-left text-xs uppercase tracking-wide text-slate-500 border-b border-slate-200';
export const TABLE_BODY_ROW = 'border-b border-slate-100';
