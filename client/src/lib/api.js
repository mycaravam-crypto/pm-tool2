...
export const api = {
  projects: {
    ...
    assignStakeholder: (id, stakeholder_id, project_role) => post(`/projects/${id}/stakeholders`, { stakeholder_id, project_role }),
    setStakeholderRole: (id, stakeholderId, project_role) => patch(`/projects/${id}/stakeholders/${stakeholderId}`, { project_role }),
