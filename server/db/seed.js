...
const seed = db.transaction(() => {
  ...
  const insertStakeholder = db.prepare('INSERT INTO stakeholders (name, email, role) VALUES (?, ?, ?)');
  ...
  const insertDecision = db.prepare('INSERT INTO decisions (event_id, text, decided_by) VALUES (?, ?, ?)');
  ...
  const e1 = addEvent({
    ...
    date: '2026-01-20',
    type: 'kickoff',
    summary: 'Initial kickoff meeting with stakeholders.',
  ...
  const e2 = addEvent({
    ...
    date: '2026-05-05',
    type: 'workshop',
    summary: 'Collaborative workshop to align on design direction.',
  ...
  addEvent({
    ...
    date: '2026-07-05',
    type: 'review',
    summary: 'Review of latest sprint deliverables.',
  ...
  addEvent({
    ...
    date: '2026-02-15',
    type: 'milestone',
    summary: 'Stakeholders signed off on the final requirements doc.',
    status: 'achieved',
  });

  addEvent({
    project_id: website,
    title: 'Accessibility Audit Deadline',
    date: '2026-06-25',
    type: 'deadline',
  ...
  const e5 = addEvent({
    ...
    date: '2026-06-20',
    type: 'retro',
    summary: 'Retrospective on Q2 progress.',
    participants: [alice, bob, carol],
  });
  ...
  addEvent({
    project_id: campaign,
    title: 'Mid-campaign Sync',
    date: '2026-04-15',
    type: 'sync',
    summary: 'Check-in on campaign metrics.',
    participants: [dave, carol],
  });

  addEvent({
    project_id: campaign,
    title: 'Creative Concept Deadline',
    date: '2026-05-01',
    type: 'deadline',
    summary: 'Agency was due to deliver final creative concepts.',
    status: 'missed',
  });
  ...
  const e9 = addEvent({
    project_id: campaign,
    title: 'Messaging Workshop',
    date: '2026-06-10',
    type: 'workshop',
    summary: 'Refine campaign messaging.',
    participants: [dave, alice, carol],
  });
  ...
  const memberAlice = insertMember.run(
    'Alice Chen',
    'alice@example.com',
    alice,
    demoHash,
  ...
  const memberBob = insertMember.run(
    'Bob Martinez',
    'bob@example.com',
    bob,
    demoHash,
    ...
    0,
    0,
  ).lastInsertRowid; // wants "assigned to you" only
  const memberDave = insertMember.run(
    'Dave Okafor',
    'dave@example.com',
    dave,
    demoHash,
  ...
  const memberGrace = insertMember.run(
    'Grace Park',
    'grace@example.com',
    null,
    null,
